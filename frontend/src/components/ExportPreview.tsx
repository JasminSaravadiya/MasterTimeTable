...
export default function ExportPreview() {
  ...
  return (
    <div className="flex h-screen bg-[#ECE7D1] text-[#2F2A1F]">
      {/* Sidebar Controls */}
      <div className="w-80 bg-[#F4F0DF] border-r border-[#C9BE9A] p-6 flex flex-col shadow-xl z-10">
        ...
        <button onClick={() => navigate('/grid')} className="mt-4 px-6 py-4 bg-[#DBCEA5] hover:bg-[#C9BE9A] text-[#5E5642] hover:text-[#2F2A1F] font-bold rounded-xl transition-all w-full">
          &larr; Back to Grid
        </button>
      </div>
